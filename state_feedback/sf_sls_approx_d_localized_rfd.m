function [R, M, acts, robust_stab] = sf_sls_approx_d_localized_rfd(A,B,C,D,T,d,comms,ta,lambda_rfd,lambda_delta,obj);

% System level synthesis with approx d-localizable constraints + actuator
% RFD
...
minimize(objective+lambda_delta*robust_stab + lambda_rfd*act_penalty)
cvx_end
