...
% expected "disturbance" (MPC knows this and designs for it)
w_expect = 0.1 * ones(1, tHorizon);

% unknown "disturbance" (step)
w_actual = [0.1 * ones(1, tHorizon/2), ones(1, tHorizon/2)];
...
for t=1:tHorizon-1
    ...
    % calculate x from dynamics and u_tilde directly    
end
